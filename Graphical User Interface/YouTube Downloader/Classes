...
class Functions:
    def __init__(self,master):
        ...
        icon = PhotoImage(file = "https://cdn-icons-png.flaticon.com/512/724/724933.png")
        master.iconphoto(False,icon)
        master.minsize(850,600)
        master.maxsize(850,600)
        ...
        self.search = Button(master, text = "Search", width = 25, command = self.vid_search,bg="#ff4500")
        self.search.grid(row = 2, column = 3, columnspan = 2, padx = 10, pady = 10)
        ...
        self.lower_quality_btn = Button(text = "Download Lower Quality",bg="#ff4500", command = self.get_lower_quality)
        ...
        self.disc = Text(master, width = 100, height = 10,bg="#ff4500")
        self.disc.grid(row =9, column = 1, columnspan = 3, padx = 10, pady = 10)

        master.configure(bg="#e5e4e2")
