...
check_factors_btn = Button(frame,text = "Check Factors",height=2,width=15,font=25,
            command=check_factors)
check_factors_btn.grid(row = 0, column=5 )

check_factors_btn = Button(frame,text = "Check Prime",height=2,width=15,font=25,
            command=check_prime)
check_factors_btn.grid(row = 1, column=5 )
