...
class Comp151Window(arcade.Window):
    ...
    def setup(self):
        self.sound1 = arcade.load_sound("Camille/GALAGA/elec_lightning.wav")
        self.player = arcade.Sprite("Camille/GALAGA/galaxy_ship.png")
        self.player.center_x = 400
        self.player.center_y = 50
        for number in range(5):
            rock = arcade.Sprite("Camille/GALAGA/meteore.png")
            self.targets.append(rock)
            rock.center_x = random.randint(16,1184)
            rock.center_y = random.randint(200,984)
